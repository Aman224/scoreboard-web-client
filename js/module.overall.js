...
$("document").ready(function() {
    ...
    function appendScore(score, index, listSize) {
        ...
        $(entry).find(".module-overall-entry-score-text")[0].innerText = parseInt(score['other_score']);
    ...
    function updateScore(score, index, listSize) {
        ...
        $(entries[index]).find(".module-overall-entry-score-text")[0].innerText = parseInt(score['other_score']);
